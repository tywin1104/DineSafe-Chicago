...
public class HashRes {
	...
	public static void main(String[] args) {
		...
		Inspection inspection3 = new Inspection(ResultT.PASS,"","12/05/2018");
		...
		Restaurant res2 = new Restaurant("aab", 1121, 1131, 121.1, 121.1);
		Restaurant res3 = new Restaurant("aas", 1131, 1141, 131.1, 131.1);
		Restaurant res4 = new Restaurant("aaf", 1111, 1121, 111.1, 121.1);
		...
		resList.add(res3);
		resList.add(res4);
		HashRes hashTable = new HashRes();
		hashTable.convertToHash(resList);
